package com.example.serverticketingsystem;
...
public class ServerTicketingSystemApplication {

    public static void main(String[] args) {
        SpringApplication.run(ServerTicketingSystemApplication.class, args);
    }
